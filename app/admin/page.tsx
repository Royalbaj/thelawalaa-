  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <Link href="/admin/orders" className="inline-flex items-center gap-2 rounded-xl bg-brand-orange text-white px-4 py-2.5 text-sm font-bold shadow-sm hover:brightness-110 transition">
          📋 View All Orders
        </Link>
        <Link href="/admin/menu" className="inline-flex items-center gap-2 rounded-xl bg-white text-brand-brown px-4 py-2.5 text-sm font-bold shadow-sm border border-stone-200 hover:bg-stone-50 transition">
          🍽️ Manage Menu
        </Link>
        <Link href="/admin/announcements" className="inline-flex items-center gap-2 rounded-xl bg-white text-brand-brown px-4 py-2.5 text-sm font-bold shadow-sm border border-stone-200 hover:bg-stone-50 transition">
          📢 Announcements
        </Link>
      </div>
